...
describe('Register Page Responsivity Tests', () => {
  ...
  describe('Mobile View (375px)', () => {
    ...
    it('should render the register form on mobile', () => {
      const { container } = renderComponent();
      // Verifikasi ini adalah halaman Register dengan elemen spesifik
  ...
  describe('Tablet View (768px)', () => {
    ...
    it('should render the register form on tablet', () => {
      renderComponent();
  ...
  describe('Laptop View (1024px)', () => {
    ...
    it('should render the register form on laptop', () => {
      renderComponent();
      expect(document.body).toBeInTheDocument();
    });
  });
  ...
  describe('Desktop View (1440px)', () => {
    ...
    it('should render the register form on desktop', () => {
      renderComponent();
      expect(document.body).toBeInTheDocument();
    });
  });
